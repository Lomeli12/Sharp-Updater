...
Sharp-Updater is a Generic Updater running under .NET and/or Mono environment.
...
So if you run a commercial or open a source project and you release your program at regular intervals, then you may need Sharp-Updater to notice your users the new update.
